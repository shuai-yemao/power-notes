...
个人学习知识库博客，使用原生 HTML、CSS 和 JavaScript 构建，Markdown 文件作为笔记内容源。`index.html` 是个人首页，`library.html` 是知识库首页，负责知识库地图、层级目录与检索。
...
然后打开 <http://127.0.0.1:4173/index.html> 查看个人首页，或打开 <http://127.0.0.1:4173/library.html> 进入知识库首页。
